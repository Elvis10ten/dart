...
import TestListPage from './Work/TestList';
import TestDetails from './Work/TestDetails';
...
export const RoutedContent = () => {
    return (
        <Switch>
            <Redirect from="/" to="/work/abacus/Samsung+S9/tests" exact />
            ...
            <Route component={ TestListPage } path="/work/:workId/:deviceName/tests" />
            <Route component={ TestDetails } path="/work/:workId/:deviceName/test/:testId" />
